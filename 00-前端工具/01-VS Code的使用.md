...
- 「option / Ctrl + 左右方向键」：在**单词**之间移动光标 。（很常用）

- 「Cmd / Fn + 左右方向键」：在**整行**之间移动光标。（很常用）
...
| Mac快捷键 | Win快捷键 | 作用 | 备注 |
|:-------------|:-------------|:-----|:-----|
| **option + delete** | **Ctrl + Backspace** | 删除光标之前的一个单词	 | 英文有效，很常用 |
| option + backspace | Ctrl + delete  | 删除光标之后的一个单词 |  |
...
- Cmd + F（Win用户是 Ctrl + F）：在当前文件中搜索，光标在搜索框里
